...
- 流水线任务不选择代码扫描配置。
- 保存流水线任务时，系统按流水线应用 + 代码源仓库自动创建或关联基础扫描配置。
- 任务参数用于覆盖本条流水线的扫描行为。
...
- 保存流水线任务时，系统按流水线应用 + 代码源仓库自动创建或关联基础扫描配置，并复用同仓库 SonarQube 项目。
...
| 当前流水线应用未配置代码扫描 | 保存流水线任务时，自动创建或关联基础扫描配置 |
